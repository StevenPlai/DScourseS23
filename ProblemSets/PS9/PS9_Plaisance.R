...
# Create the housing_train dataset using the training portion of the split
housing_train <- training(housing_split)

# Create the housing_test dataset using the testing portion of the split
...
housing_prep <- housing_recipe %>% prep(housing_train , retain=T)
